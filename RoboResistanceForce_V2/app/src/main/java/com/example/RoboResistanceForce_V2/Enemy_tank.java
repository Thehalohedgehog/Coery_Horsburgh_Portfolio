...
public class Enemy_tank extends GameObject{
    ...
    //Set the waypoints for the two locations it will move between
    public void setWaypoints(float x1, float x2){
        waypointX1 = x1;
        waypointX2 = x2;
    }

    //Move between its two waypoints and update its hitbox location
