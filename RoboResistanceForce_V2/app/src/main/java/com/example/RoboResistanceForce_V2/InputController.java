...
public class InputController {
    ...
    //Sets up the button's sizes and locations
    ...
    //Gets the buttons for player input
    ...
    //Handles input of pressing each button in different situations
            ...
            if(l.isPlaying()) {
                switch (motionEvent.getAction() &
                    ...
                    case MotionEvent.ACTION_UP:
                        if (right.contains(x, y) && !jump.contains(x, y)) {
                            l.player.setPressingRight(false);
