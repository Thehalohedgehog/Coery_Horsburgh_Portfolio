...
//Controls the camera and scaling objects appropriately
...
public class Viewport {
    ...
    //Scale an object to fit the screen size correctly
    ...
    //Remove any objects not in view of the camera
    ...
    //Move the camera when game is paused to look around the level
