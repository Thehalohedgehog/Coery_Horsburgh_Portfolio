...
public class Player extends GameObject {
    ...
    //Set up the player with hitboxes and stats
    Player(Context context, float worldStartX, float worldStartY, int pixelsPerMetre, int fireRate, int damage, String bitmapName, float xVel) {
        ...
        setFacing(LEFT);
        isFalling = false;
        bfg = new MachineGun(damage, 25);
        bfg.setFireRate(fireRate);
    ...
    //Move the player based on input and location, update their hitboxes
    ...
    //Restore their x velocity if they aren't falling
